...
var Errors = map[string]string{
	...
	`entrypoint_have_parameters`:   `entry point is cannot have parameters`,
	`require_return_value`:         `return statement of non-void functions should have return value`,
	`void_function_return_value`:   `void function is cannot returns any value`,
