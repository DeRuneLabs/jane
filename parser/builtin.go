	...
	Globals: []*Var{
		{
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.I8) + "{" + strconv.FormatInt(math.MaxInt8, 10) + "}"},
			},
		},
		{
			Pub:     true,
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.I8) + "{" + strconv.FormatInt(math.MinInt8, 10) + "}"},
			},
		},
	},
}
	...
	Globals: []*Var{
		{
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.I16) + "{" + strconv.FormatInt(math.MaxInt16, 10) + "}"},
			},
		},
		{
			Pub:     true,
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.I16) + "{" + strconv.FormatInt(math.MinInt16, 10) + "}"},
			},
		},
	},
}
	...
	Globals: []*Var{
		{
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.I32) + "{" + strconv.FormatInt(math.MaxInt32, 10) + "}"},
			},
		},
		{
			Pub:     true,
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.I32) + "{" + strconv.FormatInt(math.MinInt32, 10) + "}"},
			},
		},
	},
}
	...
	Globals: []*Var{
		{
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.I64) + "{" + strconv.FormatInt(math.MaxInt64, 10) + "}"},
			},
		},
		{
			Pub:     true,
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.I64) + "{" + strconv.FormatInt(math.MinInt64, 10) + "}"},
			},
		},
	},
}
	...
	Globals: []*Var{
		{
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.U8) + "{" + strconv.FormatUint(math.MaxUint8, 10) + "}"},
			},
		},
	},
}
	...
	Globals: []*Var{
		{
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.U16) + "{" + strconv.FormatUint(math.MaxUint16, 10) + "}"},
			},
		},
	},
}
	...
	Globals: []*Var{
		{
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.U32) + "{" + strconv.FormatUint(math.MaxUint32, 10) + "}"},
			},
		},
	},
}
	...
	Globals: []*Var{
		{
			...
			Expr: models.Expr{
				Model: exprNode{jntype.CxxId(jntype.U64) + "{" + strconv.FormatUint(math.MaxUint64, 10) + "}"},
			},
		},
	},
}
...
var f32min_model = exprNode{jntype.CxxId(jntype.F32) + "{1.17549435082228750796873653722224568e-38F}"}
...
var f64min_model = exprNode{jntype.CxxId(jntype.F64) + "{2.22507385850720138309023271733240406e-308}"}
